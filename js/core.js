class GenerateContent {
    ...
    //Se utiliza para obtener el año actual y luego actualizar el contenido de un elemento HTML con la clase "date" con ese año
  ...
  //Para convertir el de div de arriba en un elemento HTML
    htmlToElement = (html) => {
    ...
    //Pasar el objeto de la fruta a la pagina web.
  ...
  //Introducimos todas las imagenes y el contenido del div de arriba en la pagina IMPORTANTE.
